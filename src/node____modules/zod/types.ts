import { type zodCustomErrors } from "../../locales/ar.js";
...
export type zodI18nMessage = { i18n?: zodCustomErrors };
...
export type ZodStringCheck =
  | ({ kind: "min"; value: number; message?: string } & zodI18nMessage)
  | ({ kind: "max"; value: number; message?: string } & zodI18nMessage)
  | ({ kind: "length"; value: number; message?: string } & zodI18nMessage)
  | ({ kind: "email"; message?: string } & zodI18nMessage)
  | ({ kind: "url"; message?: string } & zodI18nMessage)
  | ({ kind: "emoji"; message?: string } & zodI18nMessage)
  | ({ kind: "uuid"; message?: string } & zodI18nMessage)
  | ({ kind: "nanoid"; message?: string } & zodI18nMessage)
  | ({ kind: "cuid"; message?: string } & zodI18nMessage)
  | ({
      kind: "includes";
      value: string;
      position?: number;
  ...
  | ({ kind: "cuid2"; message?: string } & zodI18nMessage)
  | ({ kind: "ulid"; message?: string } & zodI18nMessage)
  | ({ kind: "startsWith"; value: string; message?: string } & zodI18nMessage)
  | ({ kind: "endsWith"; value: string; message?: string } & zodI18nMessage)
  | ({ kind: "regex"; regex: RegExp; message?: string } & zodI18nMessage)
  | ({ kind: "trim"; message?: string } & zodI18nMessage)
  | ({ kind: "toLowerCase"; message?: string } & zodI18nMessage)
  | ({ kind: "toUpperCase"; message?: string } & zodI18nMessage)
  | ({ kind: "jwt"; alg?: string; message?: string } & zodI18nMessage)
  | ({
      kind: "datetime";
      offset: boolean;
      local: boolean;
  ...
  | ({ kind: "duration"; message?: string } & zodI18nMessage)
  | ({ kind: "ip"; version?: IpVersion; message?: string } & zodI18nMessage)
  | ({ kind: "cidr"; version?: IpVersion; message?: string } & zodI18nMessage)
  | ({ kind: "base64"; message?: string } & zodI18nMessage)
  | ({ kind: "base64url"; message?: string } & zodI18nMessage);
